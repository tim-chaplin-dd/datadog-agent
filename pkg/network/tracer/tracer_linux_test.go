...
func RunServers() func() {
	...
	return func() {
		exec.Command("docker-compose", "-f", dir+"/testdata/docker-compose.yml", "down").Run()
	}
}
...
func TestProtocolClassification(t *testing.T) {
	...
	t.Run("with dnat", func(t *testing.T) {
		...
		netlink.SetupDNAT(t)
		testProtocolClassification(t, cfg, "127.0.0.1", "2.2.2.2", "1.1.1.1:0")
